...
public class TestPiano{
	...
	CompetenzaSpeciali CompetenzaSpeciali = new CompetenzeSpeciali(competenzeSpecialiArr, 5);
    ...
    public void TestGetterProprieta() {
		...
		Assert.assertEquals(piano.getCompetenzeBase().getNumVolontari(),10);
        Assert.assertArrayEquals(piano.getCompetenzeSpeciali().getArrCompetenzeSpecali(),competenzeSpeciali);
		Assert.assertEquals(piano.getCompetenzeSpeciali().getNumVolontari(),5);

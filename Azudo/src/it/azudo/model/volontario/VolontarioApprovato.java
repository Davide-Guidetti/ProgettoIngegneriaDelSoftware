...
public class VolontarioApprovato extends Volontario {
	...
	public List<Turno> getTurniCompatibili(Piano p) {
		...
		for(Turno turnoPiano : p.getTurni()) {
			...
			if(!turniVolontario.contains(turnoPiano)) { //se non e un piano che abbiamo esplicitamente sottoscritto, verificiamo che sia compatibile
	...
	//in piu deve avere almeno un turno compatibile (ossia non sovrapposto con altri turni sottoscritti)
